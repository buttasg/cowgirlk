...
class Wyomind_Simplegoogleshopping_Block_Adminhtml_Simplegoogleshopping_Edit_Tab_Configuration extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('simplegoogleshopping_description', 'textarea', array(
            ...
            'after_element_html' => '<form method="POST" action="http://www.wyomind.com/google-shopping-magento-wizard.html" target="_blank" id="sgs-wizard">
                <input name="data" type="hidden" value="' . urlencode(json_encode($attributesList)) . '"/>
                <input name="key" type="hidden"     value="' . Mage::getStoreConfig("simplegoogleshopping/license/activation_key") . '"/>
                <input name="license" type="hidden" value="' . Mage::getStoreConfig("simplegoogleshopping/license/activation_code") . '"/>
                <input name="domain" type="hidden" value="' . Mage::getStoreConfig("web/secure/base_url") . '"/>
                <input name="version" type="hidden" value="' . Mage::getStoreConfig("simplegoogleshopping/license/version") . '"/>
                <h3 style=" margin: 20px 0 0 0;"> <a style="text-decoration:none;" href="javascript:$(\'sgs-wizard\').submit()">&#10150;  Need help?  Try our configuration wizard!</a></h3>
                </form>',
        ));
