...
class AW_Giftcard_Helper_Data extends Mage_Core_Helper_Abstract
{
    public function getEmailGiftcodeItemsBlock()
    {
        $className = Mage::getConfig()->getBlockClassName('core/template');
        $block = new $className;
        $block->setTemplate('aw_giftcard/email/giftcodes.phtml');
