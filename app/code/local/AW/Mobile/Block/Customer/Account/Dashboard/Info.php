...
class AW_Mobile_Block_Customer_Account_Dashboard_Info extends Mage_Downloadable_Block_Customer_Products_List
{
    ...
    {
        return $this->getUrl('awmobile/downloadable/noway');
    }
