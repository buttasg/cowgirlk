...
class AW_Mobile_Model_Core_Design_Package extends Mage_Core_Model_Design_Package
{
    ...
    {
        if ($this->getArea() == 'adminhtml' || $name == 'aw_iphone_force_check') {
            return parent::setPackageName();
        }
        if (($this->_targetIsMobile() && $name == $this->_helper()->getMobilePackage()) || !$this->_targetIsMobile()) {
