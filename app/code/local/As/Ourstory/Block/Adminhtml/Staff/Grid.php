...
class As_Ourstory_Block_Adminhtml_Staff_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('ourstory/staff')->getCollection();
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('name', array(
          'header'    => Mage::helper('ourstory')->__('Name'),
          'align'     =>'left',
          'index'     => 'name',
      ));
