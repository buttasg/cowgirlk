...
if(!defined('MagicZoomPlusModuleCoreClassLoaded')) {
    ...
    class MagicZoomPlusModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            $headers[] = '<!-- Magic Zoom Plus Magento module version v4.9.17 [v1.4.6:v4.5.28] -->';
        ...
        function getMainTemplate($params) {
            ...
            return "<a{$link} class=\"MagicZoomPlus\"{$title} id=\"MagicZoomPlusImage{$id}\" href=\"{$img}\" {$rel}><img itemprop=\"image\"{$width}{$height} src=\"{$thumb}\" alt=\"{$alt}\" />{$description}</a>{$message}";
        }
