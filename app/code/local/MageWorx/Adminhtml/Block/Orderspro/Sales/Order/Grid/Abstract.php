...
if (Mage::getConfig()->getModuleConfig('Mage_Epay')->is('active', true)) {
     class MageWorx_Adminhtml_Block_Orderspro_Sales_Order_Grid_Abstract extends Mage_Epay_Block_Adminhtml_Order_Grid {}
    ...
    class MageWorx_Adminhtml_Block_Orderspro_Sales_Order_Grid_Abstract extends Innoexts_Warehouse_Block_Adminhtml_Sales_Order_Grid {
    ...
    class MageWorx_Adminhtml_Block_Orderspro_Sales_Order_Grid_Abstract extends AW_Ordertags_Block_Adminhtml_Sales_Order_Grid {
    ...
    class MageWorx_Adminhtml_Block_Orderspro_Sales_Order_Grid_Abstract extends Mage_Adminhtml_Block_Sales_Order_Grid {
        ...
        protected function _prepareCollection() {
            if (method_exists($this, '_getCollectionClass')) {
                // for 1.4.1.+
                $collection = Mage::getResourceModel('orderspro/order_grid_collection');
