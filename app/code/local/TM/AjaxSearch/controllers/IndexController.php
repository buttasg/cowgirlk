...
//            ->addAttributeToSort($attributeToSort, $attributeSortOrder)
    ...
    public function indexAction()
    {
        ...
        if (1 < count($suggestions)) {
            $suggestions[] = array('html' =>
                	'<div class="view_all_btn"><a href="'.$searchURL.'"><img src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN).'frontend/default/cowgirlkim/images/view-all-btn.png" title="View All"></a></div>'
				);
        }
